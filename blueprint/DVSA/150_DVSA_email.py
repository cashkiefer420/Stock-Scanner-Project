...
JSON_FILES = {
    "150_DVSA.json": {"emails": []},
    "Filtered_DVSA_150.json": {"stocks": []},
    "ut_150_DVSA.json": {"used_tickers": []}
}
...
# File paths
EMAILS_FILE = os.path.join(JSON_FOLDER, "150_DVSA.json")
STOCKS_FILE = os.path.join(JSON_FOLDER, "Filtered_DVSA_150.json.json")
USED_TICKERS_FILE = os.path.join(JSON_FOLDER, "ut_150_DVSA.json")
...
<html>
  ...
  <body>
    <div class="email-container">
      <div class="header">
        Stock Alert: {{ stock_symbol }} DAILY VOLUME HIGH - DVSA Alert
      </div>
      <div class="content">
        <p>Dear Investor,</p>
        ...
        <p>
          ...
          <strong>DVAV - Daily Volume Over Average Volume:</strong> <span class="highlight">${{ DVAV }}</span><br>
          <strong>DVSA - Volume Today Over Shares Available :</strong> <span class="highlight">${{ DVSA }}</span><br>
        </p>

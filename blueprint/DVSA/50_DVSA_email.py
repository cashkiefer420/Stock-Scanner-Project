...
JSON_FILES = {
    "50_DVSA.json": {"emails": []},
    "Filtered_DVSA_50.json": {"stocks": []},
    "ut_50_DVSA.json": {"used_tickers": []}
}
...
# File paths
EMAILS_FILE = os.path.join(JSON_FOLDER, "50_DVSA.json")
STOCKS_FILE = os.path.join(JSON_FOLDER, "Filtered_DVSA_50.json.json")
USED_TICKERS_FILE = os.path.join(JSON_FOLDER, "ut_50_DVSA.json")

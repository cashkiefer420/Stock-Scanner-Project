...
filters = [
    ...
    {"file_name": os.path.join(output_directory, "Filtered_DVSA_50.json"), "condition": lambda ticker: float(ticker.get("DVSA (Volume Today Over Shares Available)", 0)) > 50, "field": "DVSA (Volume Today Over Shares Available)"},
    {"file_name": os.path.join(output_directory, "Filtered_DVSA_100.json"), "condition": lambda ticker: float(ticker.get("DVSA (Volume Today Over Shares Available)", 0)) > 100, "field": "DVSA (Volume Today Over Shares Available)"},
    {"file_name": os.path.join(output_directory, "Filtered_DVSA_150.json"), "condition": lambda ticker: float(ticker.get("DVSA (Volume Today Over Shares Available)", 0)) > 150, "field": "DVSA (Volume Today Over Shares Available)"},
]

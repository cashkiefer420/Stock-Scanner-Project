...
JSON_FILES = {
    "30_mc_in.json": {"emails": []},
    "Filtered_market_cap_30_in.json": {"stocks": []},
    "ut_30_mc_in.json": {"used_tickers": []}
}
...
# File paths
EMAILS_FILE = os.path.join(JSON_FOLDER, "30_mc_in.json")
STOCKS_FILE = os.path.join(JSON_FOLDER, "Filtered_market_cap_30_in.json")
USED_TICKERS_FILE = os.path.join(JSON_FOLDER, "ut_30_mc_in.json")
...
<html>
  ...
  <body>
    <div class="email-container">
      <div class="header">
        Stock Alert: {{ stock_symbol }} Market Cap Increase 30%
      </div>
      <div class="content">
        <p>Dear Investor,</p>

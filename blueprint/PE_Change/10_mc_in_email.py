...
JSON_FILES = {
    "10_mc_in.json": {"emails": []},
    "Filtered_market_cap_10_in.json": {"stocks": []},
    "ut_10_mc_in.json": {"used_tickers": []}
}
...
# File paths
EMAILS_FILE = os.path.join(JSON_FOLDER, "10_mc_in.json")
STOCKS_FILE = os.path.join(JSON_FOLDER, "Filtered_market_cap_10_in.json")
USED_TICKERS_FILE = os.path.join(JSON_FOLDER, "ut_10_mc_in.json")
...
<html>
  ...
  <body>
    <div class="email-container">
      <div class="header">
        Stock Alert: {{ stock_symbol }} Market Cap Increase 10%
      </div>
      <div class="content">
        <p>Dear Investor,</p>

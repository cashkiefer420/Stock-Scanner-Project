...
JSON_FILES = {
    "30_de_pe_subs.json": {"emails": []},
    "Filtered_pe_30_de.json": {"stocks": []},
    "ut_30_pe_de.json": {"used_tickers": []}
}
...
# File paths
EMAILS_FILE = os.path.join(JSON_FOLDER, "30_de_pe_subs.json")
STOCKS_FILE = os.path.join(JSON_FOLDER, "Filtered_pe_30_de.json")
USED_TICKERS_FILE = os.path.join(JSON_FOLDER, "ut_30_pe_de.json")
...
<html>
  ...
  <body>
    <div class="email-container">
      <div class="header">
        Stock Alert: {{ stock_symbol }} P/E Decrease 30%
      </div>
      <div class="content">
        <p>Dear Investor,</p>

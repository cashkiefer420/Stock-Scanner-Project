...
JSON_FILES = {
    "30_in_pe_subs.json": {"emails": []},
    "Filtered_pe_30_in.json": {"stocks": []},
    "ut_30_pe_in.json": {"used_tickers": []}
}
...
# File paths
EMAILS_FILE = os.path.join(JSON_FOLDER, "30_in_pe_subs.json")
STOCKS_FILE = os.path.join(JSON_FOLDER, "Filtered_pe_30_in.json")
USED_TICKERS_FILE = os.path.join(JSON_FOLDER, "ut_30_pe_in.json")
...
<html>
  ...
  <body>
    <div class="email-container">
      <div class="header">
        Stock Alert: {{ stock_symbol }} P/E Increase 30%
      </div>
      <div class="content">
        <p>Dear Investor,</p>

...
JSON_FILE = os.path.join(BASE_DIR, 'json', '20_volume.json')
STOCK_INFO_FILE = os.path.join(BASE_DIR, 'json', 'Filtered_volume_20.json')
USED_TICKERS_FILE = os.path.join(BASE_DIR, 'json', 'ut_volume_20.json')
...
def send_stock_notifications():
    try:
        ...
        <html>
          <body>
            <h1>Stock <strong>{{ stock_symbol }}</strong> Twenty Million Volume Notification</h1>
            <p>Dear Investor,</p>

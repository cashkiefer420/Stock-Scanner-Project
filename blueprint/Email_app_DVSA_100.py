...
JSON_FILE = os.path.join(BASE_DIR, 'json', '100_DVSA.json')
USED_TICKERS_FILE = os.path.join(BASE_DIR, 'json', 'ut_DVSA_100.json')
...
def send_stock_notifications():
    try:
        ...
        <html>
          <body>
            <h1>Stock <strong>{{ stock_symbol }}</strong> High Volume Notification !! DVSA 100% !! </h1>
            <p>Dear Investor,</p>

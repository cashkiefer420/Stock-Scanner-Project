...
JSON_FILES = {
    "50_price_in.json": {"emails": []},
    "Filtered_price_50_in.json": {"stocks": []},
    "ut_50_price_in.json": {"used_tickers": []}
}
...
# File paths
EMAILS_FILE = os.path.join(JSON_FOLDER, "50_price_in.json")
STOCKS_FILE = os.path.join(JSON_FOLDER, "Filtered_price_50_in.json")
USED_TICKERS_FILE = os.path.join(JSON_FOLDER, "ut_50_price_in.json")
...
<html>
  ...
  <body>
    <div class="email-container">
      <div class="header">
        Stock Alert: {{ stock_symbol }} Price Increase 50%
      </div>
      <div class="content">
        <p>Dear Investor,</p>
        <p>The stock <strong>{{ stock_symbol }}</strong> has increased significantly today.</p>
        <p>

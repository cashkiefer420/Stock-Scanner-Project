...
JSON_FILES = {
    "20_price_in.json": {"emails": []},
    "Filtered_price_20_in.json": {"stocks": []},
    "ut_20_price_in.json": {"used_tickers": []}
}
...
# File paths
EMAILS_FILE = os.path.join(JSON_FOLDER, "20_price_in.json")
STOCKS_FILE = os.path.join(JSON_FOLDER, "Filtered_price_20_in.json")
USED_TICKERS_FILE = os.path.join(JSON_FOLDER, "ut_20_price_in.json")
...
<html>
  ...
  <body>
    <div class="email-container">
      <div class="header">
        Stock Alert: {{ stock_symbol }} Price Decrease 2o%
      </div>
      <div class="content">
        <p>Dear Investor,</p>

...
JSON_FILES = {
    "75_price_in.json": {"emails": []},
    "Filtered_price_75_in.json": {"stocks": []},
    "ut_75_price_in.json": {"used_tickers": []}
}
...
# File paths
EMAILS_FILE = os.path.join(JSON_FOLDER, "75_price_in.json")
STOCKS_FILE = os.path.join(JSON_FOLDER, "Filtered_price_75_in.json")
USED_TICKERS_FILE = os.path.join(JSON_FOLDER, "ut_price_75_in.json")
...
<html>
  ...
  <body>
    <div class="email-container">
      <div class="header">
        Stock Alert: {{ stock_symbol }} Price Increase 75%
      </div>
      <div class="content">
        <p>Dear Investor,</p>

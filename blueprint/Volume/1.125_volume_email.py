...
# File paths
EMAILS_FILE = os.path.join(JSON_FOLDER, "1.125_volume.json")
STOCKS_FILE = os.path.join(JSON_FOLDER, "Filtered_volume_1.125x.json")
...
<html>
  ...
  <body>
    <div class="email-container">
      <div class="header">
        Stock Alert: {{ stock_symbol }} 1.125 Average Volume Today
      </div>
      <div class="content">
        <p>Dear Investor,</p>

...
JSON_FILES = {
    "2.5_volume.json": {"emails": []},
    "Filtered_volume_2.5x.json": {"stocks": []},
    "ut-2.5-volume.json": {"used_tickers": []}
}
...
# File paths
EMAILS_FILE = os.path.join(JSON_FOLDER, "2.5_volume.json")
STOCKS_FILE = os.path.join(JSON_FOLDER, "Filtered_volume_2.5x.json")
USED_TICKERS_FILE = os.path.join(JSON_FOLDER, "ut-2.5-volume.json")
...
<html>
  ...
  <body>
    <div class="email-container">
      <div class="header">
        Stock Alert: {{ stock_symbol }} 2.5 Average Volume Today
      </div>
      <div class="content">
        <p>Dear Investor,</p>

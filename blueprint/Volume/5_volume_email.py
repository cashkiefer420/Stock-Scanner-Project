...
JSON_FILES = {
    "5x_volume.json": {"emails": []},
    "Filtered_volume_5x.json": {"stocks": []},
    "ut-5x-volume.json": {"used_tickers": []}
}
...
# File paths
EMAILS_FILE = os.path.join(JSON_FOLDER, "5x_volume.json")
STOCKS_FILE = os.path.join(JSON_FOLDER, "Filtered_volume_5x.json")
USED_TICKERS_FILE = os.path.join(JSON_FOLDER, "ut-5x-volume.json")
...
<html>
  ...
  <body>
    <div class="email-container">
      <div class="header">
        Stock Alert: {{ stock_symbol }} 5x Times Average Volume Today
      </div>
      <div class="content">
        <p>Dear Investor,</p>

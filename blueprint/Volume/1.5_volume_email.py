...
JSON_FILES = {
    "1.5_volume.json": {"emails": []},
    "Filtered_volume_1.5x.json": {"stocks": []},
    "ut-1.5-volume.json": {"used_tickers": []}
}
...
# File paths
EMAILS_FILE = os.path.join(JSON_FOLDER, "1.5_volume.json")
STOCKS_FILE = os.path.join(JSON_FOLDER, "Filtered_volume_1.5x.json")
USED_TICKERS_FILE = os.path.join(JSON_FOLDER, "ut-1.5-volume.json")
...
<html>
  ...
  <body>
    <div class="email-container">
      <div class="header">
        Stock Alert: {{ stock_symbol }} 1.5 Average Volume Today
      </div>
      <div class="content">
        <p>Dear Investor,</p>

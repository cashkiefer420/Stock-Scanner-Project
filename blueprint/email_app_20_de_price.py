...
JSON_FILE = os.path.join(BASE_DIR, 'json', '20_price_de.json')
STOCK_INFO_FILE = os.path.join(BASE_DIR, 'json', 'Filtered_price_20_de.json')
USED_TICKERS_FILE = os.path.join(BASE_DIR, 'json', 'ut_price_20_de.json')
...
def send_stock_notifications():
    try:
        ...
        <html>
          <body>
            <h1>Stock <strong>{{ stock_symbol }}</strong> Down Twenty Percent Notification</h1>
            <p>Dear Investor,</p>

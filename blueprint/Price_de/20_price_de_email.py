...
JSON_FILES = {
    "20_price_de.json": {"emails": []},
    "Filtered_price_20_de.json": {"stocks": []},
    "ut_20_price_de.json": {"used_tickers": []}
}
...
# File paths
EMAILS_FILE = os.path.join(JSON_FOLDER, "20_price_de.json")
STOCKS_FILE = os.path.join(JSON_FOLDER, "Filtered_price_20_de.json")
USED_TICKERS_FILE = os.path.join(JSON_FOLDER, "ut_20_price_de.json")
...
<html>
  ...
  <body>
    <div class="email-container">
      <div class="header">
        Stock Alert: {{ stock_symbol }} Price Decrease 20%
      </div>
      <div class="content">
        <p>Dear Investor,</p>

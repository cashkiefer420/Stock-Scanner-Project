...
JSON_FILE = os.path.join(BASE_DIR, 'json', '10_volume.json')
STOCK_INFO_FILE = os.path.join(BASE_DIR, 'json', 'Filtered_volume_10.json')
USED_TICKERS_FILE = os.path.join(BASE_DIR, 'json', 'ut_volume_10.json')
...
@app.route('/subscribe-volume-10-td', methods=['POST'])
def subscribe_email():
    try:
